...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light"><b>I-Educate Admin</b></span>
    </a>
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item ">
                    <a href="<?= $site_url ?>admin/dashboard.php" class="nav-link ">
                        <i class="nav-icon fas fa-th-large text-pink"></i>
                        <p>
                            Dashboard
                        </p>
                    </a>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/addnote.php" class="nav-link">
                        <i class="nav-icon fas fa-book-open text-green"></i>
                        <p>Add notes</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/studentdetail.php" class="nav-link">
                        <i class="nav-icon fas fa-user-graduate text-yellow"></i>
                        <p>Student Details</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/studentfeedback.php" class="nav-link">
                        <i class="nav-icon fas fa-comment-alt text-pink"></i>
                        <p>Student Feedbacks</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/coursebuyers.php" class="nav-link">
                        <i class="nav-icon fas fa-shopping-cart text-green"></i>
                        <p>Course Buyers</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/paymentstatus.php" class="nav-link">
                        <i class="nav-icon fas fa-info-circle text-yellow"></i>
                        <p>Payment Status</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= $site_url ?>admin/sellreport.php" class="nav-link">
                        <i class="nav-icon fas fa-check-circle text-pink"></i>
                        <p>Sell Report</p>
                    </a>
                </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <!-- <li class="nav-item">
                            <a href="<?= $site_url ?>admin/schoollibrary.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Library</p>
                            </a>
                        </li> -->
