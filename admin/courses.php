...
<section class="content">
                            ...
                            <tbody>
                                ...
                                while ($course = mysqli_fetch_object($course_query)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $course->date ?></td>
                                        <td>
                                            <form action="" method="POST" class="d-inline"><input type="hidden" name="coursedelete" value=<?= $course->id ?>><button type="submit" class="btn btn-primary" name="delete" value="Delete"><i class="far fa-trash-alt"></i></button></form>
                                        </td>
    ...
    if (isset($_REQUEST['delete'])) {
        $delete = "DELETE FROM courses WHERE id = {$_REQUEST['coursedelete']}";
